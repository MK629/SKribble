...
const MiniProfileCard = () => {
  ...
  const updateUserInfo = async () => {
    await getCurrentUserInfo().then((response) => {setProfileInfo(response.getCurrentUserInfo)}).catch((e) => {toast.error(e.message)});
  }
  ...
  return (
    <div className="w-56 bg-gray-200 border-[1px] border-black shadow-xl rounded-xl p-4 flex flex-col gap-3">
        <div className="flex flex-col gap-1 border-b-[1px] border-black pb-3">
